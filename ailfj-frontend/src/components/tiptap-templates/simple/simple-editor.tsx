...
export function SimpleEditor({
  ...
  /** Initial editor content (HTML/JSON). Falls back to the template's demo content. */
  content?: string
  /** Called with the serialized HTML content on every edit - preserves formatting (bold, alignment, etc). */
  onUpdate?: (html: string) => void
  placeholder?: string
  /** false = read-only rendering, no toolbar. Defaults to true (fully editable). */
  editable?: boolean
  /** Extra buttons rendered at the end of the sticky toolbar row (e.g. host-app actions). */
  toolbarActions?: React.ReactNode
} = {}) {
