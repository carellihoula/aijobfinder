...
import {
  ...
  FileX, RefreshCw, Sparkles, RotateCcw, X,
} from "lucide-react"
import { Document, Page, pdfjs } from "react-pdf"
import Layout from "../components/Layout"
import { fetchCvPdf, fetchCoverLetterPdfBlob } from "../api/apply"
...
export default function DocumentsPage() {
  ...
  const visible = showAll ? docs : docs.slice(0, LIST_LIMIT)
                  ...
                  {hasMore && (
                    ...
                    >
                      {showAll
                        ...
                        : <><ChevronDown className="h-3 w-3" /> Voir plus · {docs.length - LIST_LIMIT} de plus</>
                      }
                    </button>
                  )}
                </div>
